...
@WHILE_NOTZERO
   ...
   @CALL GameParse
   :Break
   @POPI BlueVal @POPI GreenVal @POPI RedVal
#   @PRT "B:" @PRTI BlueVal @PRT " G:" @PRTI GreenVal @PRT " R:" @PRTI RedVal @PRTNL
   @POPI DataPtr

   @INT2LONGVV RedVal LongRed
   @PRT "LongRed: " @PRT32 LongRed @PRTSP
   @INT2LONGVV GreenVal LongGreen
   @PRT "LongGreen: " @PRT32 LongGreen @PRTSP   
   @PRT "LongRed: " @PRT32 LongRed @PRTSP
   @MUL32VVV LongRed LongGreen LongRed
   @PRT " MUL32: " @PRT32 LongRed @PRTSP
   #
   @INT2LONGVV BlueVal LongBlue
   @MUL32VVV LongRed LongBlue LongBlue
   @PRT " MUL32: " @PRT32 LongBlue @PRTSP   

   @ADD32VVV GameSum LongBlue GameSum
   @PRT " Running Game Sum: " @PRT32 GameSum @PRTNL
   @INCI DataPtr
   @PUSHI DataPtr @SUB DataListEnd   
@ENDWHILE
@PRT "Sum: " @PRT32 GameSum
@END
