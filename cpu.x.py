        ...
        while True:
            if ActiveMacro and line == "":
                ...
                if line == "":
                    ...
                    while GetAnother:
                        ...
                        if "POPRETURN" in inline and StoreMem[0x103] == 1:
                            print("Break Here")
            ...
            if len(line) > 0:
                ...
                # Here is were we start the 'switch case' looking for commands.
                    ...
                    if ( key in GlobeLabels ):
                        GlobeLabels.update({key: address})
                        print("Resetting key's ", key, "value to", address);
                    ...
                    print("FileLables adding: ", key, newitem)
                    ...
                    fvalue=address
                    if ( key in FWORDLIST):
                        fvalue=FWORDLIST[key][1]
                    else:
                        FWORDLIST.append([key,-1,0,key])
                        print("Adding ",key," to future word list")
                        fvalue=0xffff
                    print("Debug Key: ", key, fvalue)
                    GlobeLabels.update({key: fvalue})
                    line = line[size+1:]
                    continue
                else:
