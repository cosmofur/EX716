...
M PRTLN @JMP _J%0J1 :_%0M1 %1 "\n\0" :_J%0J1 @PUSH CastPrintStr @CSO @CAST $_%0M1
# Print simple test message with no variables no linefeed
M PRT @JMP _J%0J1 :_%0M1 %1 0 :_J%0J1 @PUSH CastPrintStr @CSO @CAST $_%0M1
# Print Fixed Message to stderr
M PRTERR @JMP _J%0J1 :_%0M1 %1 0 :_J%0J1 @PUSH CastPrintErrMsg @CSO @CAST $_%0M1
...
M PRTCHS @JMP _%0SkipF \
     :_%0Data 0 \
     :_%0SkipF @DUP @AND 0xff @CSO @POPI _%0Data @PUSH CastPrintChar @CSO @CAST _%0Data
# Print string whos address is on the stack
M PRTSS @JMP _%0Skip :_%0ptr 0 :_%0Skip @CSO @POPI _%0Ptr @PUSH CastPrintCharI @CSO @CAST _%0ptr 0
# Print value Pointer is pointing at.
M PRTII @PUSHII %1 @CSO @POPI _%0Store \
        @PUSH CastPrintInt @CSO @CAST :_%0Store 0
...
# Print Line feed
M PRTNL @JMP _%0A :_%0NL 10 $$0 :_%0A @PUSH CastPrintStr @CSO @CAST _%0NL
# Print a space by itself
M PRTSP @JMP _%0AJ :_%0M " \0" :_%0AJ @PUSH CastPrintStr @CSO @CAST _%0M
# Print immediate value (usefull to print value of pointer)
# Print N number of spaces
M PRTSPN  @JMP _%0A  \
         :_%0M %REPEAT %1 $$0x20  %ENDR \
         $$0  :_%0A @PUSH \
         CastPrintStr @CSO @CAST _%0M
M PRTREF @PUSH CastPrintInt @CAST %1
# Print top value in stack but leave it there.
M PRTTOP @DUP @JMP _J%0J1 :_%0M1 0 :_J%0J1 @CSO @POPI _%0M1 @PUSH CastPrintIntI @CSO @CAST _%0M1
# Print Top valine in Hex
M PRTHEXTOP @DUP @JMP _J%0J1 :_%0M1 0 :_J%0J1 @CSO @POPI _%0M1 @PUSH CastPrintHexI @CSO @CAST _%0M1
# Print Direct value as Hex
M PRTHEXREF @PUSH %1 @PRTHEXTOP @POPNULL
# Print Top with Sign
M PRTSGNTOP @DUP @CSO @POPI _%0Store @PUSH CastPrintSignI @CSO @CAST _%0Store @JMP _%0Skip :_%0Store 0 :_%0Skip
...
M TAPEREADI @PUSH PollReadTapeI @PUSHI %1 @CSO @POPI _%0_LOC @POLL :_%0_LOC 0
...
#
I structureDS.ld
M SIZESINCECOMMENT commonDS.mc
@SIZESINCE
ENDBLOCK
