...
#@Call32(AA) MUL32S $$$8000 $$$8000   @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # max 16-bit × 16-bit
#@Call32(AA) MUL32S $$$8001 $$$8001   @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # max 16-bit × 16-bit
#@Call32(AA) MUL32S $$$0xffff $$$0xffff   @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # max 16-bit × 16-bit
@END

#@Call(AA) MUL16x32U 40000 40000             @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL

@Call32(AA) MUL32S $$$32767 $$$32767   @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # max 16-bit × 16-bit

@Call32(AA) MUL32S $$$-1 $$$200000     @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL
@Call32(AA) MUL32S $$$0xffff1234 $$$1  @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL


@Call32(AA) MUL32S $$$65535 $$$65535   @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # unsigned wrap
@Call32(AA) MUL32S $$$-20000 $$$20001  @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # negative × positive
@Call32(AA) MUL32S $$$-30000 $$$-30000 @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # neg × neg = pos
@Call32(AA) MUL32S $$$100000 $$$-600000 @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL  # large mixed signs
@Call32(AA) MUL32S $$$0x7fffffff $$$2  @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # signed overflow
@Call32(AA) MUL32S $$$0x80000000 $$$2  @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL   # negative overflow
@Call32(AA) MUL32S $$$0x12345678 $$$0x10 @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL # left-shift behavior
@Call32(AA) MUL32S $$$0xffffffff $$$0xffffffff @POP32I(V) AVar @PRTHEXI AVar+2 @PRTHEXI AVar @PRTSP @PRT32I AVar @PRTNL # -1 × -1
...
@PRT "AND: " @PRT32I RVar @PRTNL

@PUSHI AVar @PUSHI AVar+2
@PUSHI BVar @PUSHI BVar+2
@CALL OR32
@POPI RVar+2 @POPI RVar
@PRT "OR: " @PRT32I RVar @PRTNL

@PUSHI ThreeVar @PUSHI ThreeVar+2
@PUSHI AVar @PUSHI AVar+2
@CALL XOR32
@POPI RVar+2 @POPI RVar
@PRT "XOR: " @PRT32I RVar @PRTNL

@PUSHI AVar @PUSHI AVar+2
@CALL INV32
@POPI RVar+2 @POPI RVar
@PRT "INV A: " @PRT32I RVar @PRTNL

@PUSHI AVar @PUSHI AVar+2
@CALL COMP232
@POPI RVar+2 @POPI RVar
@PRT "COMP232 A: " @PRT32I RVar @PRTNL
...
@ForIA2B Index2 2 3
   ...
   @POPI RVar+2
   @POPI RVar
   @PRT " Test: " @PRTI Index2 @PRT " = " @PRT32I RVar @PRTNL
@Next Index2
